                        ...
                        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-dialog-md">
                            <div className="modal-content">
                                ...
                                <div className="form-group">
                                    ...
                                    <select name="skills" className="js-states form-control select2-hidden-accessible" style={{width:'100%'}} id="skillsfield12" multiple="" data-select2-id="select2-data-skillsfield12" tabIndex="-1" aria-hidden="true" onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.skills}>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <select name="city" className="js-states form-control select2-hidden-accessible" style={{width:'100%'}} id="project_contactcity" data-select2-id="select2-data-project_contactcity" tabIndex="-1" aria-hidden="true" onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.city}>
                                            <option  data-select2-id="select2-data-10-h50i">Select city*</option>
                                            <option value="3387"  data-select2-id="select2-data-11-mvj2">Chandigarh</option>
                                            </select>
                                            <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-9-wtos" style={{width: '100%'}}><span className="selection"><span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="0" aria-disabled="false" aria-labelledby="select2-project_contactcity-container" aria-controls="select2-project_contactcity-container"><span className="select2-selection__rendered" id="select2-project_contactcity-container" role="textbox" aria-readonly="true" title="Chandigarh">Chandigarh</span><span className="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span className="dropdown-wrapper" aria-hidden="true"></span></span>
                                            <div className="help-block"></div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <select name="state" className="js-states form-control" style={{width:'100%'}} id="project_contactstate" onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.state}>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            ...
                                            <select name="country" id="project_contactcountry2" className="form-control" onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.country}>
