                    ...
                    <form onSubmit={this.form.handleSubmit}>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="form-group">
                                ...
                                <select onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.skills} name="skills" id="skillsName32" className="select2-hidden-accessible" style={{width:'100%'}} multiple="" tabIndex="-1" aria-hidden="true" data-select2-id="select2-data-skillsName32"></select>
                            ...
                            <div className="row">
                                ...
                                <div className="form-group">
                                    ...
                                    <select onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.city} name="city" className="form-select select2-hidden-accessible" id="contactcity3" style={{width:'100%'}} tabIndex="-1" aria-hidden="true" data-select2-id="select2-data-contactcity3"></select>
                                    <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-34-ieto" style={{width: '100%'}}>
                                    <span className="selection">
                                        <span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="0" aria-disabled="false" aria-labelledby="select2-contactcity3-container" aria-controls="select2-contactcity3-container">
                                        <span className="select2-selection__rendered" id="select2-contactcity3-container" role="textbox" aria-readonly="true" title="Select City">
                                ...
                                <div className="form-group">
                                    ...
                                    <select onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.state} name="state" className="form-select " id="contactstate3">
                            ...
                            <div className="row">
                                ...
                                <div className="form-group">
                                    ...
                                    <select onBlur={this.form.handleBlurEvent} onChange={this.form.handleChangeEvent} value={this.state.fields.country} name="country" id="contactcountry3" className="form-select ">
